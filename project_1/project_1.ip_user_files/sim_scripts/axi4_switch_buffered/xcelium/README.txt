...
#
# Generated by export_simulation on Tue Jul 08 09:50:10 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './axi4_switch_buffered.sh' script.

./axi4_switch_buffered.sh -reset_run
...
./axi4_switch_buffered.sh -noclean_files

For more information on the script, please type './axi4_switch_buffered.sh -help'.
